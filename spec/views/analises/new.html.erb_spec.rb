...
RSpec.describe "analises/new", type: :view do
  before(:each) do
    assign(:analise, Analise.new(
      Mg2: 1.5,
      Ca2: 1.5,
      K: 1.5,
      N: 1.5,
  ...
  it "renders new analise form" do
    render

    assert_select "form[action=?][method=?]", analises_path, "post" do
